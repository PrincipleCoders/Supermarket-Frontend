...
function About() {
  return (
    ...
    <div>
        <p>ShopX is proudly Sri Lankan, owned and operated over the last 25 years, delivering the freshest quality products, along with great value, serving thousands of Sri Lankans every day.
...
ShopX was also the first retailer in Sri Lanka to commit to reduce by 50%, single-use polythene bags and in-store prepared food packaging by the year 2025, ensuring that as the business grows, the impact on the environment is minimized, and sustainable practices are employed. Over 57 of our stores also use solar power, relying more on renewable sources of energy as another initiative towards being sustainable.</p>
    ...
    <div>
        ...
        <div>
            <p>
1.Sri Lankan Heritage: ShopX is a proudly Sri Lankan supermarket with a 25-year legacy of delivering high-quality products and excellent value to our fellow Sri Lankans.

2.Part of John Keells Group: As a subsidiary of the renowned John Keells Group, ShopX operates a network of 116 supermarkets, including 6 franchise outlets under the 'Super K' brand.

3.Our Mission: We are on a mission to enhance the quality of life for the nation by providing conveniently located supermarkets that offer a world-class retail experience.

4.Passionate Team: Our team of over 4500 dedicated individuals shares a profound passion for fresh food, and they are at the core of our success, ensuring delightful shopping experiences for our customers.

5.shpxus Loyalty Program: ShopX takes shopping to the next level with the Nexus loyalty program. With over 1.3 million members, it offers great deals, savings, and the opportunity to earn points on every purchase.
            </p>
        </div>
    </div>
      </div>
